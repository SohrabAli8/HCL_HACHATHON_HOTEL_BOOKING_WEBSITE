# 🏨 Hotel Booking System (HCL Hackathon 2026)
...
## 🏆 HCL Hackathon 2026 - Team: Codeflow Crew

**Date:** April 16, 2026

We are **Codeflow Crew**! This project was built for the HCL Hackathon. 

### 👥 Team Members & Contributions

| Member | Focus Area / Responsibilities |
|--------|-------------------------------|
| **Soharab Ali** | Booking Service Controller, all booking-related features |
| **Vaibhav Tiwari** | Room list, hotel list and related functionality |
| **Vaibhav Kumar Dubey** | Authentication and authorization (Auth part) |
| **Shivam Dubey** | Coupon functionality, search features, and database |
| **Team Effort (All)**| Everyone collaboratively worked on all other frontend, backend, and database parts |
